  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <nav className="relative bg-white shadow px-6 flex items-center justify-between">
        ...
        {/* 메뉴 (가운데 정렬) */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex gap-20">
          <Link
            to="/"
            className="text-gray-700  font-normal hover:text-black tracking-wide hover:font-semibold transition">
            플래닝
          </Link>
          <Link
            to="/stats/weekly"
